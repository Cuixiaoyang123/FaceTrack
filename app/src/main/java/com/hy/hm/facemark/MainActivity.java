            ...
            public void onPreviewFrame(byte[] data, Camera camera) {
                ...
                mHandler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        for (int j = 0; j < faceActions.size(); j++) { //Face r : faceActions
                            Face r = faceActions.get(j);
...
//                        }
                        ...
                        if (list != null) {
                            for (Float[] f:list) {
                                float[] subPionts = new float[106 * 2];
                                for (int i=0 ;i< f.length;i++) {
                                    subPionts[i] = f[i];
                                }
                                mPoints.setPoints(subPionts);
                                mPoints.drawPoints();
                            }
                        }
                        mEglUtils.swap();
